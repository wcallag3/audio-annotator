...
WaveSurfer.Drawer.NoFillCanvas = Object.create(WaveSurfer.Drawer);

WaveSurfer.util.extend(WaveSurfer.Drawer.NoFillCanvas, {
    ...
    drawWave: function (peaks, channelIndex) {
        ...
        this.waveCc.strokeStyle = this.params.waveColor;
        if (this.progressCc) {
            this.progressCc.strokeStyle = this.params.progressColor;
        }
